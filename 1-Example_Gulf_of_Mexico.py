...
plt.plot(np.arange(len(vC['coefficient'])), vC['coefficient'])
...
fig = plt.figure()
ax = plt.axes()
ax.plot(nodes, GOMSimV['shadowp'], color='blue');
ax.title.set_text('V Apprximation of Price')
ax.title.set_text('P Approximation of Price')
ax.title.set_text('P-dot Approximation of Price')
